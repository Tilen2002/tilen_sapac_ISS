...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    @vite('resources/js/naloga5/naloga09/funkcije.js')
...
<body class="p-5">  
    ...
    <div class="w-full flex items-center pb-1 text-sky-900 font-bold text-lg">Treuntna naloga:
        <h1 class="px-2 flex font-bold text-sky-500 text-lg">Naloga09</h1>
    </div>
    <ol class="novice">
        <li>
    ...
    <div class="w-full flex">
        <p class="p-2 hover:cursor-pointer">
            <img id="back" height="50px" width="50px" src="{{ asset('ikone/arrow.png') }}" alt="Arrow back" style="transform: rotate(180deg)">
        </p>
        <p class="p-2 hover:cursor-pointer">
            <img id="next" height="50px" width="50px" src="{{ asset('ikone/arrow.png') }}" alt="Arrow back">
        </p>
    </div>
</body>
</html>
